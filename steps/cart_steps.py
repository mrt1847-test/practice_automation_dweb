...
def user_adds_to_cart(browser_session):
    """
    사용자가 현재 상품을 장바구니에 추가 (Atomic POM 조합)
...
def user_has_added_to_cart(browser_session):
    """
    사용자가 이미 장바구니에 상품을 담은 상태 (Atomic POM 조합)
...
def user_views_cart(browser_session):
    """
    사용자가 장바구니 페이지로 이동
...
def user_clicks_cart_icon(browser_session):
    """
    사용자가 장바구니 아이콘 클릭
...
@then("장바구니 페이지가 표시된다")
def cart_page_is_displayed(browser_session):
    """
    장바구니 페이지가 표시되는지 확인
...
def cart_preview_is_displayed(browser_session):
    """
...
@then("장바구니에 상품이 담겨있다")
def cart_contains_products(browser_session):
    """
    장바구니에 상품이 있는지 확인 (증명)
...
def cart_contains_products_given(browser_session):
    """
...
@then("장바구니가 비어있다")
def cart_is_empty(browser_session):
    """
    장바구니가 비어있는지 확인
...
def cart_contains_product_with_quantity(browser_session, product_name, quantity):
    """
...
def cart_total_price_is_displayed(browser_session):
    """
...
def user_changes_cart_quantity(browser_session, product_name, quantity):
    """
...
def user_removes_from_cart(browser_session, product_name):
    """
...
@when("사용자가 장바구니를 비운다")
def user_clears_cart(browser_session):
    """
    사용자가 장바구니의 모든 상품 제거
