...
def user_is_on_order_history_page(page):
...
def user_views_order_history(page):
    """사용자가 주문 내역 확인"""
...
@then("주문 내역이 표시된다")
def order_history_is_displayed(page):
    """주문 내역이 표시되는지 확인"""
...
def order_history_contains_product(page, product_name):
...
def user_views_order_detail(page, order_number):
...
@then("주문 상세 내역이 표시된다")
def order_detail_is_displayed(page):
    """주문 상세 내역이 표시되는지 확인"""
    page.wait_for_load_state("networkidle")
    # TODO: 주문 상세 내역 확인 로직 구현
...
def user_cancels_order(page, order_number):
    """사용자가 주문 취소"""
    # TODO: 주문 취소 로직 구현
...
def order_status_is_displayed(page, status):
...
def order_number_is_displayed(page, order_number):
    """주문번호가 올바르게 표시되는지 확인"""
    # TODO: 주문번호 확인 로직 구현
...
def order_completion_message_is_displayed(page):
    """주문 완료 메시지가 표시되는지 확인"""
